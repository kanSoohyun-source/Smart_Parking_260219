...
<%
    ...
    // 데이터가 없으면(추가 페이지라면) 빈 객체를 생성해서 에러를 방지함
    if (managerDTO == null) {
...
<div class="main-content">
    <div class="container">
        ...
        <form id="managerForm" action="${pageContext.request.contextPath}/mgr/view" method="post">
            <div class="form-group">
                <label for="id">아이디 <span class="required">*</span></label>
                <input type="text" id="id" name="id" readonly
                       value="<%=managerDTO.getManagerId()%>"
                       maxlength="50"
                       required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" readonly
                       value="<%=managerDTO.getManagerName()%>"
                       maxlength="20"
                       required>
