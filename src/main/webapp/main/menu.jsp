...
<nav>
    ...
    <ul id="navMenu">
        ...
        <li><a href="${pageContext.request.contextPath}/dashboard/dashboard">주차 현황</a></li>
        <li><a href="${pageContext.request.contextPath}/entry/entry">입차</a></li>
        <li><a href="${pageContext.request.contextPath}/parking/output">출차</a></li>
        <li><a href="${pageContext.request.contextPath}/member/add_member">회원 등록</a></li>
