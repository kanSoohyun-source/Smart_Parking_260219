...
<div class="main-content">
    ...
    <div id="register" class="page">
        ...
        <form name="frmAddMember" action="/member/member_modify" method="post" onsubmit="return validateForm()">

            <input type="hidden" name="carNum" id="carNum" value="<%=member.getCarNum()%>">
            ...
            <div class="form-group">
                ...
                <input type="tel" name="phone" id="phone" value="<%=member.getPhone()%>">
            </div>
