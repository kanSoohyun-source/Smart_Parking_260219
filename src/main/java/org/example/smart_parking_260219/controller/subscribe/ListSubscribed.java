...
@Log4j2
@WebServlet(name = "ListSubscribed", value = "/subscribe/list_subscribe")
public class ListSubscribed extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/subscribe/list_subscribe.jsp").forward(req, resp);
    }
}
