...
public enum SubscribeService {
    ...
    public SubscribeDTO getOneSubscribe(int memberId) throws SQLException {
        return modelMapper.map(subscribeDAO.selectOneSubscribe(memberId), SubscribeDTO.class);
    }
    ...
    public void removeSubscribe(int memberId) throws SQLException {
        subscribeDAO.deletesubscribe(memberId);
    }
