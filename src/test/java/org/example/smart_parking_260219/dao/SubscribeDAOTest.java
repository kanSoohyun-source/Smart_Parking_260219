...
class SubscribeDAOTest {
    ...
    public void selectOne() throws SQLException {
        ...
        SubscribeVO subscribeVO = subscribeDAO.selectOneSubscribe(subscriptionId);
        log.info(subscribeVO);
    ...
    public void update() throws SQLException {
        ...
        SubscribeVO subscribeVO = SubscribeVO.builder()
                ...
                .startDate(LocalDateTime.of(2024, 3, 1, 0, 0))  // 고정 날짜
        ...
        SubscribeVO result = subscribeDAO.selectOneSubscribe(subscriptionId);
    ...
    public void deleteTest() throws SQLException {
        int subscriptionId = 4;
        subscribeDAO.deletesubscribe(subscriptionId);
    }
}